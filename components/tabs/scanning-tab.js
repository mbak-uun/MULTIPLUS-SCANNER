...
const TokenRow = {
  ...
  methods: {
    ...
    formatDexCell(dexKey, direction) {
      ...
      // Ambil modal dari database token, fallback ke modalUsd global
      const tokenModal = this.token.modal || this.token.modalUsd || this.modalUsd;
      ...
      <td class="token-detail">
        <div class="d-flex flex-column align-items-center">
          ...
          <div class="mb-2 small">
           ...
           <div class="token-aggregator-links d-flex gap-1 mb-2 small">
