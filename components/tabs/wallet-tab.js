  ...
  template: `
    <div class="wallet-tab position-relative">
      ...
      <div v-if="walletCards.length" class="row g-2">
        <div v-for="card in walletCards" :key="card.key" class="col-6">
            ...
            <div class="card-body p-2">
              <div class="vstack gap-2">
                <div v-for="chain in card.chainEntries" :key="chain.chainKey" class="wallet-chain-block">
                  <div class="wallet-chain-badge" :style="getChainBadgeStyle(chain.chainKey)">
                    {{ chain.chainLabel }}
                  </div>
                  <div class="wallet-chain-addresses">
                    <div
