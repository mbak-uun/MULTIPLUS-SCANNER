  ...
  methods: {
    ...
    async checkSelectedExchanges() {
      ...
      if (enabledExchanges.length === 0) {
        this.notify('Tidak ada exchange yang diaktifkan', 'warning');
        return;
      }
    ...
    async checkWalletBalances(walletToCheck = null) {
      ...
      if (walletsToProcess.length === 0) {
        this.notify('Tidak ada Wallet Chain yang diaktifkan', 'warning');
        return;
      }
      ...
      <div class="row g-2">
        ...
        <div class="col-lg-4 d-flex flex-column gap-2">
          <div class="card portfolio-card">
            <div class="card-header d-flex justify-content-between align-items-center" :style="cardHeaderStyles">
        ...
        <div class="col-lg-4 d-flex flex-column gap-2">
          ...
          <div class="card portfolio-card">
            <div class="card-header d-flex justify-content-between align-items-center" :style="cardHeaderStyles">
              <h6 class="mb-0"><i class="bi bi-cash-coin me-2"></i>MODAL SETTING</h6>
            </div>
            <div class="card-body">
